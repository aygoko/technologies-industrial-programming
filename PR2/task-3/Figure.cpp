...
Figure::Figure(float x1, float x2, float x3, float x4, float y1, float y2, float y3, float y4) :
    ...
    perimeter = sqrt(d1) + sqrt(d2) + sqrt(d3) + sqrt(d4);
    ...
    float b1 = sqrt(d2);
    float b2 = sqrt(d3);
    float s1 = (a1 + b1 + sqrt(d3)) / 2;
    float s2 = (a2 + b2 + sqrt(d1)) / 2;
    area = sqrt(s1 * (s1 - a1) * (s1 - b1) * (s1 - sqrt(d3))) + sqrt(s2 * (s2 - a2) * (s2 - b2) * (s2 - sqrt(d1)));
}
